...
import { shop, carrierShopId, pubsubConfig, paymentSubName, APIGEE,mallFlowUrl ,mallServiceUrl } from "./paymentConfig"
...
export const actionDispatcher = async (response, dialogMessage: DialogMessage): Promise<void> => {
...
paymentSub.on("message", async (message) => {
