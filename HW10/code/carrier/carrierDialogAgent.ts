...
export const dialogAgent = async (request, dialogMessage: DialogMessage): Promise<any> => {
...
const getSessionId = (req, res) => {
    ...
    if (!sessionId) {
        assistant.createSession({ assistant_id: ASSISTANT.assistantId }, (err, result) => {
